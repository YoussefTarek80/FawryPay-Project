...
public class ProviderLogic {
    ...
    ProviderLogic(){}
    public String providerMobile(String Number,String Email,String ProviderType,double Amount,String PayMethod){
...
//        amount -= (amount *(discount/100.0));
    ...
    public String providerInternet(String Number,String Email,String ProviderType,double Amount,String PayMethod){
//        MobileRechargeServices MRS =new MobileRechargeServices();
//        amount -= (amount *(discount/100.0));
        if (ProviderType.equals("WE")){
            for (Customer customer:DB.usersTable) {
